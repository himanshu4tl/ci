...
<!--            </li>-->
    ...
    <aside class="main-sidebar sidebar-dark-primary">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="<?= ADMIN_DIR;?>site/profile" class="d-block"><?= $user['name'];?></a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item"><a href="<?= ADMIN_DIR;?>site/dashboard" class="nav-link"><i class="fa fa-tachometer-alt nav-icon"></i><p> Dashboard</p></a></li>
                   
                    <li class="nav-item"><a href="<?= ADMIN_DIR;?>user" class="nav-link"><i class="fa fa-file-alt nav-icon"></i><p> Users</p></a></li>
                    <li class="nav-item"><a href="<?= ADMIN_DIR;?>page" class="nav-link"><i class="fa fa-file-alt nav-icon"></i><p> Pages</p></a></li>
                    <li class="nav-item"><a href="<?= ADMIN_DIR;?>site/logout" class="nav-link"><i class="fa fa-sign-out-alt nav-icon"></i><p> Logout</p></a></li>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; <?= APP_NAME.' '.date('Y')?> <a href="#"></a></strong>
        All rights reserved.
