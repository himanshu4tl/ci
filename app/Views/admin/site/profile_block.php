    ...
    <div class="pro-info">
        <table>
            <tbody>
                ...
                <tr>
                    <td colspan="2">
                        <a class="btn btn-default" style="width:100%" href="<?= ADMIN_DIR;?>site/profile">Profile</a>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <a href="<?= ADMIN_DIR;?>site/password_change" style="width:100%" class="btn btn-default">Change Password</a>
                    </td>
